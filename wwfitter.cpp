...
//static int events_per_iteration = 10000;
...
//    RAT::DB::Get()->Load("AGED_CONCENTRATOR_PARAMS.ratdb");
   ...
   //save bestfit
    ...
    sprintf(buffy2, "test_bestfit_%s.root",dataset_chars);
...
int main(int argc, char* argv[])
{
   ...
   dataset_info = dataset;
    ...
    //set starting values(?)
    RAT::DB::Get()->SetD("AGED_CONCENTRATOR_PARAMS", "", "p0", 0.8);
...
//    ScaleProperly(SNOpmtr);
    ...
    min.SetParameter(0, "p0", fp0, 1.0, 0., 1.);
